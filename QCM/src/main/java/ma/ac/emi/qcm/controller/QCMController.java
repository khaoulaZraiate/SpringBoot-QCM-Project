...
public class QCMController {
	...
	public String listQcm(Model model, @RequestParam(name = "formateur_id", defaultValue = "") String formateurLogin,
		...
		model.addAttribute("listeDeQcms",qcmService.getListQcm() );
	...
	@RequestMapping(value = "/saveQcm", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/showFormAddQcm" )
	public String showFormForAdd(@ModelAttribute("SpringWeb") QCM newQcm, Model model1) {
